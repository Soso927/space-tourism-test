    ...
    <section class="max-w-3xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('admin.planets.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" id="slug_fr" name="slug_fr" value="{{ old('slug_fr') }}"
            ...
            <div>
                ...
                <input type="text" id="slug_en" name="slug_en" value="{{ old('slug_en') }}"
            ...
            <div>
                ...
                <input type="text" step="0.01" id="distance" name="distance" value="{{ old('distance') }}"
            ...
            <div>
                ...
                <input type="text" step="1" min="0" id="duration" name="duration"
                    value="{{ old('duration') }}" class="w-full rounded border border-white/10 bg-white/5 px-3 py-2"
                    placeholder="ex : 6" required>
                @error('duration')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="file" id="image" name="image" accept="image/*"
                    class="w-full rounded border border-white/10 bg-white/5 px-3 py-2" required>
                @error('image')
                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                @enderror>
